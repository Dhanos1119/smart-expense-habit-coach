...
import { analyticsStyles } from "../../src/styles/analyticsStyles";
...
export default function AnalyticsPage() {
  ...
  const styles = analyticsStyles(colors);
  ...
  const { categoryTotals, monthTotal } = useMemo(() => {
    ...
    for (const e of monthExpenses) {
      total += e.amount;
      const category =
        e.category && e.category.trim() !== "" ? e.category : "Other";
  ...
  }, [categoryTotals, monthTotal, hasData, colors]);
